// Eliminar los imports que no se usen
...
// Corregir la indentación para facilitar la lectura
export default class Partidos extends Component {
    ...
    getGames() {
        ...
        if(diasdiferencia> 20)
        {
            ...
            // Acá faltaba añadir los parámetros en llaves para indicar que es objeto y separar por coma de la función anónima
            Meteor.call('getGame',{
                day: day,
                month:month,
                year:year,
